        ...
        <div class="container-fluid">
            ...
            <div class="row my-5">
              ...
              <div class="col">
                <span>강의 등록</span>
                <!-- form 시작-->
                <form action="./uploadCourseProcess" method="post" enctype="multipart/form-data">
                  <div class="row mt-3">
                      ...
                      <div class="col-md-12 col-lg-6  d-grid">
                        ...
                        <div class="row mb-3">
                          ...
                          <c:forEach items="${categoryList }" var="category">
                            <input type="checkbox" value="${category.category_no }" name="category_no"><span style="font-size: 14px; margin-right: 15px" > ${category.category_name }</span> 
                          	</c:forEach>
                          </div>
                        </div>
                        <div class="row">
...
<div class="row p-3 mt-3" style="background-color: aliceblue;">
                      <div class="col d-grid">
                          <textarea name="course_content" rows="5"></textarea>
                      </div>
                  </div>
                  <div class="row mt-4">
                    <div class="col">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-8" id="videoPlus">
                      <div class="row mb-2" id="videoNode">
                        <div class="col d-grid">
                          <input type="text" class="form-text px-2  mt-0" name="courseTitle" placeholder="강의 목차 제목">
                        </div>
                        <div class="col  d-grid">
                    ...
                    <div class="col text-end" style="align-self: flex-end;">
                      <input type="submit" value="강좌 등록" class="btn btn-primary">
                    </div>
                  </div>
                </form>
              </div>
